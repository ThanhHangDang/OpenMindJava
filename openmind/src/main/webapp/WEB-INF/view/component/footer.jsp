  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 mb-3">
        <h5>Về chúng tôi</h5>
        <p>Đội ngũ nhân viên OpenMind là những con người năng nổ, nhiệt huyết. Mong muốn mang đến cho tất cả mọi người các tài liệu học tập bổ ích.</p>
      </div>
      <div class="col-md-4 mb-3">
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <p>&copy; 2026 OpendMind. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
